...
public class Main {
    public static void main(String[] args) {
        ...
        newShop.addComputers(new Computer(ComputerNames.TOP,new Memory("very good",500000, 4096),
                new Monitor("the best",720,720),
                new Processor("the worst",5000,6,12),200000));
